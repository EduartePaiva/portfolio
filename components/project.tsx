...
export default function Project({
    ...
    return (
        ...
        >
            <section className=" bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative group-even:pl-8 hover:bg-gray-200 rounded-lg transition dark:bg-white/10 dark:hover:bg-white/20">
